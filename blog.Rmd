...
This is plain waffle. It uses the syntax geom_waffle(). It worls similar to waffle() function. Flip parameter makes the plot in horizontal position otherwise it would be vertical, n_rows sets the no. of row for the base of plot and size is its size of box.
```{r, fig.align= "center", fig.width= 5, fig.height= 3}
fruit_data +
  geom_waffle(
